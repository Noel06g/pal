      ...
      <div className="mx-auto max-w-md text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-teal-tint text-teal-dk">
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" aria-hidden>
            <path d="M3 6.5h18v11H3v-11Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
            <path d="m4 7 8 6 8-6" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
          </svg>
        </div>
        <h1 className="mt-6 text-2xl font-extrabold tracking-tight">{t.auth.checkEmail}</h1>
