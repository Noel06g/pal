    ...
    <ul className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
      {FIELDS.map((f) => (
        <li key={f.key}>
          ...
          >
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] bg-teal-tint font-display text-base font-bold text-teal-dk group-hover:bg-teal group-hover:text-white">
              {f.n}
            </span>
